function metticuore(event)
{
  ...
  console.log(img_e);
  console.log('ok');
  //console.log('http://localhost/provahw2/public/preferiti_insert?titolo='+titolo_e+'&descrizione=' +descrizione_e +'&contenuto=' +contenuto_e +'&immagine=' +img_e);
  fetch('http://localhost/prova_cuore/public/preferiti_insert?titolo='+titolo_e+'&descrizione=' +descrizione_e +'&contenuto=' +contenuto_e +'&immagine=' +img_e);
